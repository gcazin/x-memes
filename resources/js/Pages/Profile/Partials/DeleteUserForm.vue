...
<template>
    ...
    <button class="btn btn-error mt-4" @click="formService.openModal('deleteAccount')">Supprimer le compte</button>
    ...
    <Modal id="deleteAccountModal" @close="closeModal">
        <div class="p-6">
            ...
            <div class="mt-6 flex justify-end">
                <button class="btn btn-secondary" @click="formService.closeModal('deleteAccount')">
                    Annuler
                </button>
