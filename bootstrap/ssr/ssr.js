      ...
      _push(ssrRenderComponent(unref(Head), { title: __props.title }, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<meta head-key="description" name="description"${ssrRenderAttr("content", (_a2 = unref(props).seo) == null ? void 0 : _a2.description)}${_scopeId}>`);
          } else {
            return [
              ...
              createVNode("meta", {
                ...
                name: "description",
                content: (_b = unref(props).seo) == null ? void 0 : _b.description
              }, null, 8, ["content"])
            ];
          }
        }),
...
const Ziggy$1 = { "url": "http://localhost", "port": null, "defaults": {}, "routes": { "debugbar.openhandler": { "uri": "_debugbar/open", "methods": ["GET", "HEAD"] }, "debugbar.clockwork": { "uri": "_debugbar/clockwork/{id}", "methods": ["GET", "HEAD"], "parameters": ["id"] }, "debugbar.telescope": { "uri": "_debugbar/telescope/{id}", "methods": ["GET", "HEAD"], "parameters": ["id"] }, "debugbar.assets.css": { "uri": "_debugbar/assets/stylesheets", "methods": ["GET", "HEAD"] }, "debugbar.assets.js": { "uri": "_debugbar/assets/javascript", "methods": ["GET", "HEAD"] }, "debugbar.cache.delete": { "uri": "_debugbar/cache/{key}/{tags?}", "methods": ["DELETE"], "parameters": ["key", "tags"] }, "filament.imports.failed-rows.download": { "uri": "filament/imports/{import}/failed-rows/download", "methods": ["GET", "HEAD"], "parameters": ["import"], "bindings": { "import": "id" } }, "filament.admin.auth.login": { "uri": "admin/login", "methods": ["GET", "HEAD"] }, "filament.admin.auth.logout": { "uri": "admin/logout", "methods": ["POST"] }, "filament.admin.pages.dashboard": { "uri": "admin", "methods": ["GET", "HEAD"] }, "filament.admin.resources.badges.index": { "uri": "admin/badges", "methods": ["GET", "HEAD"] }, "filament.admin.resources.badges.create": { "uri": "admin/badges/create", "methods": ["GET", "HEAD"] }, "filament.admin.resources.badges.view": { "uri": "admin/badges/{record}", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.badges.edit": { "uri": "admin/badges/{record}/edit", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.media.index": { "uri": "admin/media", "methods": ["GET", "HEAD"] }, "filament.admin.resources.media.create": { "uri": "admin/media/create", "methods": ["GET", "HEAD"] }, "filament.admin.resources.media.view": { "uri": "admin/media/{record}", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.media.edit": { "uri": "admin/media/{record}/edit", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.roles.index": { "uri": "admin/roles", "methods": ["GET", "HEAD"] }, "filament.admin.resources.roles.create": { "uri": "admin/roles/create", "methods": ["GET", "HEAD"] }, "filament.admin.resources.roles.view": { "uri": "admin/roles/{record}", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.roles.edit": { "uri": "admin/roles/{record}/edit", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.tags.index": { "uri": "admin/tags", "methods": ["GET", "HEAD"] }, "filament.admin.resources.tags.create": { "uri": "admin/tags/create", "methods": ["GET", "HEAD"] }, "filament.admin.resources.tags.view": { "uri": "admin/tags/{record}", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.tags.edit": { "uri": "admin/tags/{record}/edit", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.users.index": { "uri": "admin/users", "methods": ["GET", "HEAD"] }, "filament.admin.resources.users.create": { "uri": "admin/users/create", "methods": ["GET", "HEAD"] }, "filament.admin.resources.users.view": { "uri": "admin/users/{record}", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "filament.admin.resources.users.edit": { "uri": "admin/users/{record}/edit", "methods": ["GET", "HEAD"], "parameters": ["record"] }, "pulse": { "uri": "admin/pulse", "methods": ["GET", "HEAD"] }, "sanctum.csrf-cookie": { "uri": "sanctum/csrf-cookie", "methods": ["GET", "HEAD"] }, "telescope": { "uri": "admin/telescope/{view?}", "methods": ["GET", "HEAD"], "wheres": { "view": "(.*)" }, "parameters": ["view"] }, "livewire.update": { "uri": "livewire/update", "methods": ["POST"] }, "livewire.upload-file": { "uri": "livewire/upload-file", "methods": ["POST"] }, "livewire.preview-file": { "uri": "livewire/preview-file/{filename}", "methods": ["GET", "HEAD"], "parameters": ["filename"] }, "log-viewer.hosts": { "uri": "admin/logs/api/hosts", "methods": ["GET", "HEAD"] }, "log-viewer.folders": { "uri": "admin/logs/api/folders", "methods": ["GET", "HEAD"] }, "log-viewer.folders.request-download": { "uri": "admin/logs/api/folders/{folderIdentifier}/download/request", "methods": ["GET", "HEAD"], "parameters": ["folderIdentifier"] }, "log-viewer.folders.clear-cache": { "uri": "admin/logs/api/folders/{folderIdentifier}/clear-cache", "methods": ["POST"], "parameters": ["folderIdentifier"] }, "log-viewer.folders.delete": { "uri": "admin/logs/api/folders/{folderIdentifier}", "methods": ["DELETE"], "parameters": ["folderIdentifier"] }, "log-viewer.files": { "uri": "admin/logs/api/files", "methods": ["GET", "HEAD"] }, "log-viewer.files.request-download": { "uri": "admin/logs/api/files/{fileIdentifier}/download/request", "methods": ["GET", "HEAD"], "parameters": ["fileIdentifier"] }, "log-viewer.files.clear-cache": { "uri": "admin/logs/api/files/{fileIdentifier}/clear-cache", "methods": ["POST"], "parameters": ["fileIdentifier"] }, "log-viewer.files.delete": { "uri": "admin/logs/api/files/{fileIdentifier}", "methods": ["DELETE"], "parameters": ["fileIdentifier"] }, "log-viewer.files.clear-cache-all": { "uri": "admin/logs/api/clear-cache-all", "methods": ["POST"] }, "log-viewer.files.delete-multiple-files": { "uri": "admin/logs/api/delete-multiple-files", "methods": ["POST"] }, "log-viewer.logs": { "uri": "admin/logs/api/logs", "methods": ["GET", "HEAD"] }, "log-viewer.folders.download": { "uri": "admin/logs/api/folders/{folderIdentifier}/download", "methods": ["GET", "HEAD"], "parameters": ["folderIdentifier"] }, "log-viewer.files.download": { "uri": "admin/logs/api/files/{fileIdentifier}/download", "methods": ["GET", "HEAD"], "parameters": ["fileIdentifier"] }, "log-viewer.index": { "uri": "admin/logs/{view?}", "methods": ["GET", "HEAD"], "wheres": { "view": "(.*)" }, "parameters": ["view"] }, "ignition.healthCheck": { "uri": "_ignition/health-check", "methods": ["GET", "HEAD"] }, "ignition.executeSolution": { "uri": "_ignition/execute-solution", "methods": ["POST"] }, "ignition.updateConfig": { "uri": "_ignition/update-config", "methods": ["POST"] }, "index": { "uri": "/", "methods": ["GET", "HEAD"] }, "library.image": { "uri": "bibliotheque/images", "methods": ["GET", "HEAD"] }, "library.video": { "uri": "bibliotheque/videos", "methods": ["GET", "HEAD"] }, "random": { "uri": "au-hasard", "methods": ["GET", "HEAD"] }, "leaderboard": { "uri": "classement", "methods": ["GET", "HEAD"] }, "user.show": { "uri": "membre/{username}", "methods": ["GET", "HEAD"], "parameters": ["username"] }, "user.badge.index": { "uri": "membre/{username}/badges", "methods": ["GET", "HEAD"], "parameters": ["username"] }, "user.media.liked": { "uri": "membre/{username}/publications-likees", "methods": ["GET", "HEAD"], "parameters": ["username"] }, "media.show": { "uri": "media/{slug}", "methods": ["GET", "HEAD"], "parameters": ["slug"] }, "media.download": { "uri": "media/{id}/telecharger", "methods": ["GET", "HEAD"], "parameters": ["id"] }, "search": { "uri": "rechercher/{query?}", "methods": ["GET", "HEAD"], "parameters": ["query"] }, "user.follow": { "uri": "suivre/{id}", "methods": ["POST"], "parameters": ["id"] }, "user.update": { "uri": "membre/modifier-informations", "methods": ["POST"] }, "profile.edit": { "uri": "profil", "methods": ["GET", "HEAD"] }, "profile.update": { "uri": "profil", "methods": ["PUT"] }, "profile.destroy": { "uri": "profil", "methods": ["DELETE"] }, "media.store": { "uri": "media", "methods": ["POST"] }, "media.edit": { "uri": "media/{medium}/edit", "methods": ["GET", "HEAD"], "parameters": ["medium"] }, "media.update": { "uri": "media/{medium}", "methods": ["PUT", "PATCH"], "parameters": ["medium"] }, "media.destroy": { "uri": "media/{medium}", "methods": ["DELETE"], "parameters": ["medium"] }, "media.duplicate": { "uri": "media/dupliquer", "methods": ["POST"] }, "media.like": { "uri": "media/{id}/like", "methods": ["GET", "HEAD"], "parameters": ["id"] }, "notification.index": { "uri": "notification", "methods": ["GET", "HEAD"] }, "notification.create": { "uri": "notification/create", "methods": ["GET", "HEAD"] }, "notification.store": { "uri": "notification", "methods": ["POST"] }, "notification.edit": { "uri": "notification/{notification}/edit", "methods": ["GET", "HEAD"], "parameters": ["notification"] }, "notification.update": { "uri": "notification/{notification}", "methods": ["PUT", "PATCH"], "parameters": ["notification"] }, "notification.destroy": { "uri": "notification/{notification}", "methods": ["DELETE"], "parameters": ["notification"] }, "notification.markAllAsRead": { "uri": "notification/marquer-tout-comme-lu", "methods": ["PUT"] }, "register": { "uri": "inscription", "methods": ["GET", "HEAD"] }, "login": { "uri": "connexion", "methods": ["GET", "HEAD"] }, "password.request": { "uri": "mot-de-passe-oublie", "methods": ["GET", "HEAD"] }, "password.email": { "uri": "mot-de-passe-oublie", "methods": ["POST"] }, "password.reset": { "uri": "reset-mot-de-passe/{token}", "methods": ["GET", "HEAD"], "parameters": ["token"] }, "password.store": { "uri": "reset-mot-de-passe", "methods": ["POST"] }, "verification.notice": { "uri": "verification-email", "methods": ["GET", "HEAD"] }, "verification.verify": { "uri": "verification-email/{id}/{hash}", "methods": ["GET", "HEAD"], "parameters": ["id", "hash"] }, "verification.send": { "uri": "email/verification-notification", "methods": ["POST"] }, "password.confirm": { "uri": "confirmation-mot-de-passe", "methods": ["GET", "HEAD"] }, "password.update": { "uri": "mot-de-passe", "methods": ["PUT"] }, "logout": { "uri": "deconnexion", "methods": ["POST"] } } };
